                    ...
                    <li className="nav-item dropdown">
                        ...
                        <ul className="dropdown-menu dropdown-menu-end dropdown-menu-arrow messages">
                            ...
                            <li className="message-item">
                                <a href="#">
                                <img src={`${process.env.MIX_APP_URL}/img/messages-1.jpg`} alt="" className="rounded-circle" />
                                <div>
                                    <h4>Jassa</h4>
                            ...
                            <li className="message-item">
                                <a href="#">
                                <img src={`${process.env.MIX_APP_URL}/img/messages-2.jpg`} alt="" className="rounded-circle" />
                                <div>
                                    <h4>Jassa</h4>
                                    <p>Velit asperiores et ducimus soluta repudiandae labore officia est ut...</p>
                                    <p>6 hrs. ago</p>
                            ...
                            <li className="message-item">
                                <a href="#">
                                <img src={`${process.env.MIX_APP_URL}/img/messages-3.jpg`} alt="" className="rounded-circle" />
                                <div>
                                    <h4>Jassa</h4>
                                    <p>Velit asperiores et ducimus soluta repudiandae labore officia est ut...</p>
                                    <p>8 hrs. ago</p>
