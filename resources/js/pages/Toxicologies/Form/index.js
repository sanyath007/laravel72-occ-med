...
import { getDoctors } from '../../../store/slices/doctor'
...
const ToxicologySchema = Yup.object().shape({
                    ...
                    <div className="card">
                        <div className="card-body">
                            ...
                            <Formik
                                ...
                                validationSchema={ToxicologySchema}
                                ...
                                {(formProps) => (
                                    <Form>
                                        ...
                                        <Tabs id="uncontrolled-tab" defaultActiveKey="service" className="mb-3">
                                            ...
                                            <Tab eventKey="checkup" title="การเยี่ยม/ติดตามผู้ป่วย">
                                                <div className="row mb-3">
                                                    <div className="col-md-6">

                                                        <div className="col-md-12 form-group mb-3">
                                                            <label htmlFor="">กระบวนการทำงาน :</label>
                                                            <select
                                                                name="lab_result"
                                                            ...
                                                            >
                                                                ...
                                                                <option value="0">ไม่เสี่ยง</option>
                                                                <option value="1">เสี่ยงต่อสุขภาพ</option>
                                                            </select>
                                                        ...
                                                        <div className="col-md-12 form-group mb-3">
                                                            <label htmlFor="">พฤติกรรมการทำงาน :</label>
                                                            <select
                                                                name="equip_result"
                                                            ...
                                                            >
                                                                <option value="">-- กรุณาเลือก --</option>
                                                                <option value="0">ปลอดภัย</option>
                                                                <option value="1">ไม่ปลอดภัย</option>
                                                            </select>
                                                        ...
                                                        <div className="col-md-12 form-group mb-3">
                                                            <label htmlFor="">พฤติกรรมส่วนบุคคล :</label>
                                                            <select
                                                                name="xray_result"
                                                            ...
                                                            >
                                                                <option value="">-- กรุณาเลือก --</option>
                                                                <option value="0">ไม่เสี่ยงต่อการเจ็บป่วย</option>
                                                                <option value="1">เสี่ยงต่อการเจ็บป่วย</option>
                                                            </select>
                                                        ...
                                                        <div className="col-md-12 form-group mb-2">
                                                            <label htmlFor="">ความสามารถขณะทำงาน :</label>
                                                            <select
                                                                name="summary_result"
                                                            ...
                                                            >
                                                                <option value="">-- กรุณาเลือก --</option>
                                                                <option value="1">ปฏิบัติงานได้</option>
                                                                <option value="2">มีข้อจำกัดในการปฏิบัติงาน</option>
                                                            </select>
                                                        ...
                                                        <div className="col-md-12 form-group mb-2">
                                                            <label htmlFor="">การเจ็บป่วย/อาการผิดปกติ :</label>
                                                            <select
                                                                name="summary_result"
                                                                value={formProps.values.summary_result}
                                                                onChange={formProps.handleChange}
                                                            ...
                                                            >
                                                                <option value="">-- กรุณาเลือก --</option>
                                                                <option value="1">สัมพันธ์กับลักษณะงาน</option>
                                                                <option value="2">ไม่สัมพันธ์กับลักษณะงาน</option>
                                                                <option value="2">ไม่ชัดเจน</option>
                                                            </select>
                                                            {formProps.errors.summary_result && formProps.touched.summary_result ? (
                                                                <div className="invalid-feedback">
                                                                    {formProps.errors.summary_result}
                                                        ...
                                                        <div className="col-md-12 form-group">
                                                            <label htmlFor="">อื่นๆ ระบุ</label>
                                                            <textarea
                                                                rows="2"
                                                                name="remark"
                                                    ...
                                                    <div className="col-md-4">
                                                        <div className="col-md-12 form-group mb-2">
                                                            <label htmlFor="">การปฏิบัติทางการพยาบาล (Implementation)</label>
